...
- **State law:** Each state has its own statutes, regulations, and court system
- **Notes:** Federal law preempts conflicting state law; circuit splits create jurisdictional variance
...
### Canada (Federal)
- **System:** Common law (except Quebec — civil law), federal system
...
### European Union
- **System:** Supranational — regulations (directly applicable) and directives (require national implementation)
...
- **Notes:** Administrative law handled by Conseil d'État, separate from judicial courts
...
### Brazil (Federal)
- **System:** Civil law, federal system
- **Sources:** Federal Constitution, Código Civil, federal/state legislation, STF decisions
...
### South Africa
- **System:** Mixed — Roman-Dutch civil law + English common law + customary law
...
### Scotland
- **System:** Mixed — civil law roots + common law influences
